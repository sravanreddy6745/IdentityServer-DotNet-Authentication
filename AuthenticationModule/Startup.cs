using AuthenticationModule.Authentication;
...
namespace AuthenticationModule
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc(options => options.Filters.Add(new ServiceActionInterceptor()));
            services.AddScoped<ServiceExceptionInterceptor>();
        }
